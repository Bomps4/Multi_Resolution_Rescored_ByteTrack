...
from ..losses import IOUloss,QualityFocalLoss,DistributionFocalLoss
import numpy as np
from ...utils.postprocess import distance2bbox
from ..Layers.Convolutional_Base import BaseConv,DWConv
from ..Layers.General_Layer import Integral
from ..Layers.Label_assigner import DynamicSoftLabelAssigner
import numpy as np 
from ...utils.env import reduce_mean
from ...utils.postprocess import bbox2distance,multi_apply
...
class NanoDetPlusHead(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ConvModule = BaseConv if conv_type == "Conv" else DWConv
        ...
        self.loss_qfl = QualityFocalLoss(
            **self.loss_cfg['loss_qfl']
            
        )
        self.loss_dfl = DistributionFocalLoss(
            **self.loss_cfg['loss_dfl']
        )
        self.loss_bbox = IOUloss(**self.loss_cfg['loss_bbox'])
        self._init_layers()
        self.init_weights()
    ...
    def _init_layers(self):
        ...
        print('len stacked convs ',len(self.cls_convs))
    ...
    def loss(self, preds, gt_meta, aux_preds=None):
        ...
        loss={"total_loss":loss,**loss_states}
    ...
    def get_bboxes(self, cls_preds, reg_preds, img_metas):
        ...
        device = cls_preds.device
        b = cls_preds.shape[0]
        input_height, input_width = img_metas
